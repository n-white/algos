...
var mergeSort = function(array) {
  ...
  var middle = Math.min(array.length / 2);
...
console.log(mergeSort([1, 3, 2, 4, 5, 7, 8, 6, 0]))

// THINGS I LEARNED:
// When you have two tasks to complete with recursion, you might need a helper function
// In this case, we had to keep spliting until we reached arrays of one
// Then we had to start sorting from there. 
// Could be a clue to use a helper if you need to do that
